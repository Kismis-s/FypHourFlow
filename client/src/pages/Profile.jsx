                  ...
                  <div className="mt-5">
                    {activeTab === "skills" && (
                      <div className="flex flex-wrap gap-3">
                        <span className="rounded border border-1 border-blue-900 px-3 py-1 text-blue-900 hover:bg-blue-600 hover:text-white ml-3">
                          Cooking
                        </span>
                        <span className="rounded border border-1 border-blue-900 px-3 py-1 text-blue-900 hover:bg-blue-600 hover:text-white">
                          Cleaning
                        </span>
                        <span className="rounded border border-1 border-blue-900 px-3 py-1 text-blue-900 hover:bg-blue-600 hover:text-white">
                          Tutoring
