      ...
      <div>
        ...
        <main className="mt-6">
          ...
          <section className="mb-6 grid grid-cols-2 gap-8">
            <div className="ml-28">
              <h2 className="text-4xl font-extrabold text-primary text-blue-950 mt-14 leading-10">
                Empowering Communities,
                <br />
                One <span className="text-blue-700">Hour</span> at a Time.
              </h2>
              <p className="text-lg text-secondary text-gray-500 mt-4">
                {" "}
                Empowering individuals to share skills and services and build
                connections and celebrate mutual support.
              </p>
          ...
          <section className="mb-6 grid grid-cols-2 gap-6 mt-9 mr-12">
            ...
            <div className="ml-16">
              <h2 className="text-4xl font-extrabold text-primary text-blue-950 mt-14 leading-10">
                Where Time Becomes Currency and{" "}
                <span className="text-blue-700">Skills</span> Build Communities.
              </h2>
              <p className="text-lg text-secondary text-gray-500 mt-4">
                {" "}
                Inspiring individuals to exchange their unique talents,
                fostering collaboration <br />
                and skill-sharing within local communities.
              </p>
              <button className="px-4 py-2 mt-6 bg-blue-950 text-white rounded hover:bg-blue-700">
                Browse services
              </button>
          ...
          <section className="py-12">
            <div className="max-w-7xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-600 mb-12">
                Welcome to{" "}
                <span className="font-bold text-blue-700">HourFlow</span>, a
                revolutionary platform dedicated to empowering individuals and
                fostering meaningful connections within communities. By
                redefining how we value time and skills, HourFlow encourages
                collaboration, mutual support, and growth.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-14">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-gray-700 leading-7 text-wrap">
                    To create a community where time is the currency,
                    encouraging members to exchange their skills and services
                    while building lasting relationships.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-gray-700 leading-7 text-wrap">
                    To inspire a future where communities thrive through shared
                    efforts, valuing time and skills over money, and building
                    trust in local neighborhoods.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-gray-700 leading-7 text-wrap">
                    HourFlow is more than a platform—it’s a movement. We focus
                    on building connections, fostering mutual respect, and
                    offering a unique way to contribute to and benefit from your
                    community without financial constraints.
                  </p>
                </div>
              </div>
            </div>
